...
describe('FileService', function () {
  ...
  describe('set_fileName()', function () {
    it('Should return 0, and the fileName should be changed', function () {
      ...
      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileName).to.be.equal(newName)
  ...
  describe('set_fileType()', function () {
    it('Should return 0, and the fileType should be changed', function () {
      ...
      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileType).to.be.equal(newType)
  ...
  describe('set_fileShareDate()', function () {
    it('Should return 0, and the fileShareDate should be changed', function () {
      ...
      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileShareDate).to.be.equal(newShareDate)
  ...
  describe('set_fileSharedBy()', function () {
    it('Should return 0, and the fileSharedBy Arr should look like: [{userID: newSharedBy}]', function () {
      ...
      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileSharedBy[0]).to.deep.equalInAnyOrder({ userID: newSharedBy })
  ...
  describe('set_fileDownloads_increase()', function () {
    it('Should return 0, and the fileDownloads should be incremented by one', function () {
      ...
      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileDownloads).to.be.equal(oldDownloadCount + 1)
  ...
  describe('set_fileLikedBy_like()', function () {
    it('Should return 0, and the fileLikedBy Arr should include {userId: newLikedId}', function () {
      ...
      const file = FileService.set_fileLikedBy_like(testFile.fileID, newLikedId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileLikedBy).to.deep.include.members([{ userId: newLikedId }])
  ...
  describe('set_fileLikedBy_unlike()', function () {
    it('Should return 0, and the fileLikedBy Arr should NOT include {userId: newLikedId}', function () {
      ...
      const file = FileService.set_fileLikedBy_unlike(testFile.fileID, unlikedId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileLikedBy).to.not.deep.include.members([{ userId: unlikedId }])
  ...
  describe('set_fileDislikedBy_dislike()', function () {
    it('Should return 0, and the fileDislikedBy Arr should include {userId: newDislikedId}', function () {
      ...
      const file = FileService.set_fileDislikedBy_dislike(testFile.fileID, newDislikedId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileDislikedBy).to.deep.include.members([{ userId: newDislikedId }])
  ...
  describe('set_fileDislikedBy_undislike()', function () {
    it('Should return 0, and the fileDislikedBy Arr should NOT include {userId: newDislkedId}', function () {
      ...
      const file = FileService.set_fileDislikedBy_undislike(testFile.fileID, undislikedId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileDislikedBy).to.not.deep.include.members([{ userId: undislikedId }])
  ...
  describe('set_fileComments_add()', function () {
    it('Should return 0, and the fileComments Arr should include {commentId: newCommentId}', function () {
      ...
      const file = FileService.set_fileComments_add(testFile.fileID, newCommentId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileComments).to.deep.include.members([{ commentId: newCommentId }])
  ...
  describe('set_fileComments_remove()', function () {
    it('Should return 0, and the fileComments Arr should NOT include {commentId: removedCommentId}', function () {
      ...
      const file = FileService.set_fileComments_remove(testFile.fileID, removedCommentId);

      expect(file).to.be.equal(0);

      expect(fileData.filter(file => file.fileID === testFile.fileID)[0].fileComments).to.not.deep.include.members([{ userId: removedCommentId }])
